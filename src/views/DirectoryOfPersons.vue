              ...
              <v-row no-gutters>
                <v-col class="pt-2 pb-2" >
                    ...
                    <v-menu offset-y>
                      <template v-slot:activator="{ on }">
                        <v-btn color="pink" width="200"
                               class="text-capitalize caption justify-start" height="32" outlined
                               dark v-on="on">
                      ...
                      <v-list>
                        <v-list-item class="" v-for="(item, index) in items" :key="index" router
                                     :to="item.route">
                          <!--route to nodal -->
                          <v-list-item-title class=" caption p-0">{{item.title }}
                          </v-list-item-title>
                        </v-list-item>
                      </v-list>
                    </v-menu>
                  ...
                  <div class="pt-2">
                    ...
                    <v-btn color="pink" class="text-capitalize justify-start" width="200"
                           height="32" outlined small dark>
                      ...
                      <span class="pl-9">Փոփոխել</span>
                        ...
                        <v-col class="pl-5" >
                          <div class="pt-2" v-for="item in buttonItems" :key="item.id">
                            <v-btn color="pink" class="text-capitalize justify-start" width="200"
                                @click="item.clickName"   height="32" outlined small dark>
                              <v-icon left class="" size="24" color="dark">{{item.iconName}}</v-icon>
                              <span :class="item.spanClassName">{{item.buttonName}}</span>
                            </v-btn>
                          </div>
<!--                          <div class="pt-2">-->
                  ...
                  <div>
                    <v-form
                      ...
                      <v-text-field success outlined label="Անուն"
                                    dense flat v-model="NAME_A" :value="NAME_A"
                                    class="caption mylabel"
                  ...
                  <div class="heightWidthClass caption">
                    <v-form
                      ...
                      <v-text-field success outlined
                                    ...
                                    label="ՀԾՀ"
                                    dense flat class="caption mylabel"
                                    prepend-inner-icon="description"></v-text-field>
                    </v-form>
                  </div>
                  <div class="heightWidthClass pt-2">
                    <v-form
                      ...
                      <v-text-field outlined label="Հեռախոս" dense success color="pink"
                                    ...
                                    flat class="caption mylabel"
                                    prepend-inner-icon="phone"></v-text-field>
                    </v-form>
                  </div>
                ...
                <v-col class="pl-5 pt-2 pb-2">
                  <div>
                    <v-menu offset-y>
                      <template v-slot:activator="{ on }">
                        <v-btn color="pink" class="text-capitalize justify-start" width="200"
                               height="32" outlined small dark v-on="on">
                  ...
                  <div class="pt-2">
                    <v-menu offset-y>
                      <template v-slot:activator="{ on }">
                        <v-btn color="pink" width="200" class="text-capitalize justify-start"
                               height="32" outlined small dark v-on="on">
                          <v-icon left size="24" color="dark">help</v-icon>
  ...
  export default {
    ...
    data() {
      return {
				...
				//   class     pl-9        ,    pl-9        , ---
				buttonItems:[
					{buttonName:"Հեռացնել", iconName:"delete_forever", buttonClassName:"",
						clickName:this.getDataMethod, spanClassName:"pl-9 "},
					{buttonName:"Կասեցնել", iconName:"emoji_people", buttonClassName:"",clickName:"",
						spanClassName:"pl-9 "},
					{buttonName:"Փոփոխել ծածկագիր", iconName:"eedit", buttonClassName:"", clickName:"",
						spanClassName:"pl-2"},
				],
